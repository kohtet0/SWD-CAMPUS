  ...
  return (
    ...
    >
      ...
      <svg
        ...
        strokeWidth="1.5"
        stroke="currentColor"
        className="w-4 h-4 hidden pointer-events-none group-disabled:flex animate-spin"
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
